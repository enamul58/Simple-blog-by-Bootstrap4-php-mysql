...
$id = $_GET['id'];
$queryResult = $view->viewAllPublishedInfoById($id);
    ...
    <div class="row text-center">
        <?php while($allPublishedInfo){?>
            <div class="col-md-8 m-auto ">
                <div class="card h-100" style="margin-top: 60px">

                    <div class="card-body">
                        <img class="card-img-top" src="admin/<?php echo $allPublishedInfo['blog_image']?>" width="300px">
                        <h4 class="card-title"><?php echo $allPublishedInfo['blog_title']?></h4>
                    </div>
                </div>
            </div>
            <p><?php echo $allPublishedInfo['long_description']?></p>
...
<!-- Footer -->
<footer class="py-2 bg-dark" style="margin-top: 200px">
    <div class="container">
