...
if(isset($_POST['singUp'])){
   $message = $users->createUserAccount( $_POST );
}
    ...
    <div class="row">
        <div class="col-md-6 m-auto" style="margin-top: 500px;">
            <div class="card">
                ...
                <div class="card-title" align="center"><strong><i>Admin Panel Sing up</i></strong></div>
                <div class="card-body">
                    <form action="" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <button type="submit" name ="singUp" class="btn btn-success">submit</button>
                                <a href="index.php" name="logIn" class="btn btn-success">LogIn</a>
                            </div>
                        </div>
                    </form>
                </div>
